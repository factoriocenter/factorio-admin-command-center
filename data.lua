-- data.lua
-- Registers:
--   1) Custom input: toggle admin GUI (Ctrl + .)
--   2) Toolbar shortcut: toggle admin GUI
--   3) Legendary Upgrader selection tool & its shortcut
--   4) Custom input: execute Lua console command (Ctrl + Enter)
...
-- 4) Console exec custom-input (Ctrl + Enter)
data:extend({
  {
    type                  = "custom-input",
